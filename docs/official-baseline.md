...
| Peeled source commit | `e363b08c9175ac1cbe5893615dd2cb9ddf95043b` |
| Cargo workspace version | `0.146.0` |
...
Conformance uses `@openai/codex@0.146.0` and `@openai/codex-sdk@0.146.0` only in isolated development
...
The vendor selection contains 287 files from the recorded production closure. Its allowlist, source
